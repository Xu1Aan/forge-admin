...
(
    ...
    `education_level` int                   DEFAULT NULL COMMENT '教育程度（外部码值）',
    `work_start_date` date                  DEFAULT NULL COMMENT '参加工作日期',
    `company_start_date` date               DEFAULT NULL COMMENT '入司日期',
    `work_year`       decimal(6, 2)         DEFAULT NULL COMMENT '工作年限（年）',
    `company_work_year` decimal(6, 2)       DEFAULT NULL COMMENT '司龄（年）',
